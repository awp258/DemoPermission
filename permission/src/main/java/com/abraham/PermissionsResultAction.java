...
/**
 * This abstract class should be used to create an if/else mViewFlag that the PermissionsManager
...
public abstract class PermissionsResultAction {
    ...
    public synchronized boolean shouldIgnorePermissionNotFound(String permission) {
        Log.i(TAG, "Permission not found: " + permission);
        return true;
    }
     ...
     * @return this method returns true if its primary mViewFlag has been completed
